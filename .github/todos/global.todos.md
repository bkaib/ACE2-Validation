...
- [ ] **[HIGH]** Run Ensemble simulations of ACE2 for the period 2001-2010 — milestone: `milestone1` — added: 2024-06-01
    ...
    - [ ] **[HIGH]** Run ensemble with IC from 1950 — milestone: `milestone1` — added: 2024-06-01
    - [ ] **[HIGH]** Run ensemble with IC from 1979 — milestone: `milestone1` — added: 2024-06-01
    - [ ] **[HIGH]** Run ensemble with IC from 2020 — milestone: `milestone1` — added: 2024-06-01
- [ ] **[HIGH]** Extract the period 2001-2010 from each simulation and save those on work? — milestone: `milestone1` — added: 2024-06-01
